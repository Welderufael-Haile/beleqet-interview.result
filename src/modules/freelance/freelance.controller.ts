...
import { CreateBidDto, CreateFreelanceJobDto, QueryFreelanceJobsDto } from './dto/freelance.dto';
...
export class FreelanceController {
  ...
  @Get('jobs')
  findJobs(@Query() q: QueryFreelanceJobsDto) { return this.svc.findJobs(q); }
